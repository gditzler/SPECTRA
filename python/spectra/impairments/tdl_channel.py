...
PROFILES: Dict[str, Dict] = {
    ...
    "TDL-D": {
        ...
        "powers_db": [-0.2, -13.5, -18.8, -21.0, -22.8, -17.9, -20.1, -21.9, -22.9, -27.8, -23.6, -24.8, -30.0],
        "k_factor_db": 13.3,
    },
    "TDL-E": {
        "delays_ns": [0, 0, 50, 55, 60, 100, 170, 195, 220, 350, 520, 610, 705, 750, 780],
        "powers_db": [-0.03, -22.03, -15.8, -18.1, -19.8, -22.9, -22.4, -18.6, -22.8, -22.6, -27.4, -20.2, -24.1, -30.0, -27.7],
        "k_factor_db": 22.0,
    },
    "PedestrianA": {
